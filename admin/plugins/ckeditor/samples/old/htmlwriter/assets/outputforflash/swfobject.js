var swfobject = function() {
    ...
    function K(a, b, c) {
        ...
        if (g)
            if ("undefined" == typeof a.id &&
                ...
                var q = "",
                    h;
                for (h in a) a[h] != Object.prototype[h] && ("data" == h.toLowerCase() ? b.pelicula = a[h] : "styleclass" == h.toLowerCase() ? q += ' class\x3d"' + a[h] + '"' : "classid" != h.toLowerCase() && (q += " " + h + '\x3d"' + a[h] + '"'));
                h = "";
    ...
    (function() {
        e.w3 && (("undefined" != typeof d.readyState &&
            "complete" == d.readyState || "undefined" == typeof d.readyState && (d.getElementsByTagName("body")[0] || d.body)) && w(), u || ("undefined" != typeof d.addEventListener && d.addEventListener("DOMContentLoaded", w, !1), e.ie && e.win && (d.attachEvent("onreadystatechange", function() { "complete" == d.readyState && (d.detachEvent("onreadystatechange", arguments.callee), w()) }), n == top && function() {
            if (!u) {
                try { d.documentElement.doScroll("left") } catch (a) { setTimeout(arguments.callee, 0); return }
                w()
            }
        }()), e.wk && function() {
