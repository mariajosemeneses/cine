			...
			<div class="footer-top">
				<div class="col_1_of_4 span_1_of_4">
					<div class="footer-nav">
		                <ul>
			  		   ...
			  		   <li><a href="peliculas_events.php" style="text-decoration:none;">Cartelera</a></li>
				...
				<div class="col_1_of_4 span_1_of_4">
					<div class="textcontact">
						...
						Sistema de Cine Online<br>
						Telf: 2633565 - 0985935920<br>
						</p>
					</div>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<div class="call_info">
						<p class="txt_3">Diseñado por: </p>
						<p class="txt_4">Grupo #</p>
					</div>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<div class=Social>
