<?php include('header.php');
	$qry2=mysqli_query($con,"select * from tbl_pelicula where pelicula_id='".$_GET['id']."'");
	$pelicula=mysqli_fetch_array($qry2);
	?>
<div class="content">
	<div class="wrap">
		<div class="content-top">
				<div class="section group">
					<div class="about span_1_of_2">	
						<h3 style="color:#444; font-size:23px;" class="text-center"><?php echo $pelicula['pelicula_name']; ?></h3>	
							<div class="about-top">	
							...
							<?php $s=mysqli_query($con,"select DISTINCT theatre_id from tbl_shows where pelicula_id='".$pelicula['pelicula_id']."'");
							...
							<?php
								...
								while($shw=mysqli_fetch_array($s))
								{
									...
									<tr>
										...
										<td>
											<?php $tr=mysqli_query($con,"select * from tbl_shows where pelicula_id='".$pelicula['pelicula_id']."' and theatre_id='".$shw['theatre_id']."'");
											while($shh=mysqli_fetch_array($tr))
											{
												...
												<a href="check_login.php?show=<?php echo $shh['s_id'];?>&pelicula=<?php echo $shh['pelicula_id'];?>&theatre=<?php echo $shw['theatre_id'];?>"><button class="btn btn-default"><?php echo date('h:i A',strtotime($ttme['start_time']));?></button></a>
												<?php
											}
											?>
										</td>
