 			...
 			<div class="listview_1_of_3 images_1_of_3">
					<h2 style="color:#555;">Peliculas Disponibles</h2>
            ...
            <div class="content-left">
					...
					<div class="text list_1_of_2">
						  <div class="extra-wrap1">
                                         <a href="about.php?id=<?php echo $m['pelicula_id'];?>" class="link4" style="text-decoration:none; font-size:18px;"><?php echo $m['pelicula_name'];?></a><br>
                                        <span class="data">Release Date: <?php echo $m['release_date'];?></span><br>
                                        Cast: <Span class="data"><?php echo $m['cast'];?></span><br>
                                        Descripcion: <span" class="color2" style="text-decoration:none;"><?php echo $m['desc'];?></span><br>
                                    </div>
					</div>
