...
CREATE TABLE `tbl_pelicula` (
  ...
  `pelicula_name` varchar(255) NOT NULL,
...
INSERT INTO `tbl_pelicula` (`pelicula_id`, `t_id`, `pelicula_name`, `cast`, `desc`, `release_date`, `image`, `video_url`, `status`) VALUES
...
(17, 6, 'Justice League', 'Ben Affleck, Henry Cavil, Ezra Miller', 'This is a demo description for the pelicula ZSJL.', '2021-03-22', 'images/zsjl.jpg', 'https://www.youtube.com/watch?v=vM-Bja2Gy04', 0);
...
INSERT INTO `tbl_shows` (`s_id`, `st_id`, `theatre_id`, `pelicula_id`, `start_date`, `status`, `r_status`) VALUES
...
--
-- Indexes for table `tbl_pelicula`
--
...
--
-- AUTO_INCREMENT for table `tbl_pelicula`
--
ALTER TABLE `tbl_pelicula`
  MODIFY `pelicula_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
