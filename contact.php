...
<body>
	<div class="header">
		<div class="header-top">
			<div class="wrap">
				<div class="h-logo">
					<a href="index.php"><img src="images/logo.png" alt="" width="50" height="50" /></a>
				</div>
				<div class="nav-wrap">
		...
		<div class="block">
			<div class="wrap">
				...
				<form action="#" id="reservation-form" method="post">
					<fieldset>
						<div class="field">
							<label>Find a pelicula:</label>
							<select class="select2">
								<option>pelicula list</option>
							</select>
						</div>
						<div class="field1">
							<label>Search</label>
							<select class="select1">
								<option>peliculas or Actors</option>
							</select>
						</div>
					</fieldset>
				</form>
